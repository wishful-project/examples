...
stations_dump = [["192.168.3.101", "alix01", 2.0, 1.0, 1, 1, 1 ,1, 1],
                ["192.168.3.102", "alix02", 2.0, 1.0, 1, 1, 1 ,1, 1],
                ["192.168.3.103", "alix03", 2.0, 1.0, 1, 1, 1 ,1, 1],
                ["192.168.3.104", "alix04", 2.0, 1.0, 1, 1, 1 ,1, 1],
...
def ho_event(x):
	...
	if local_network :
		...
		#communication with Python program
		port = "8300"
		context = zmq.Context()
