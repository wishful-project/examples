...
def my_local_control_program(controller):
	...
	#SLOT_PARAM_AREA_POINT_OFFSET 	SHM(0x00F0)
	...
	while not controller.is_stopped() :
		...
		loop_start = (current_time.tv_sec - start_time.tv_sec) * 1000000L + (current_time.tv_nsec - start_time.tv_nsec) / 1000L #(uint64_t )
		last_tsf = tsf
		tsf = b43.getTSFRegs()
		...
		current_time =  b43.monotonic_time() #(timespec)
		loop_end = (current_time.tv_sec - start_time.tv_sec) * 1000000L + (current_time.tv_nsec - start_time.tv_nsec) / 1000L
