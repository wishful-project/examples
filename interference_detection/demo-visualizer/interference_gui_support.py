...
def OpenFileDialog():
    print('interference_gui_support.OpenFileDialog')
    sys.stdout.flush()

def Quit():
    print('interference_gui_support.Quit')
    sys.stdout.flush()
    destroy_window()

def Save():
    print('interference_gui_support.Save')
    sys.stdout.flush()

def StartGatewayCommand():
    print('interference_gui_support.StartGatewayCommand')
    sys.stdout.flush()

def StopGatewayCommand():
    print('interference_gui_support.StopGatewayCommand')
    sys.stdout.flush()
...
def change_state_zigbee(*args):
    global driver
    print('interference_gui_support.change_state_zigbee')
    sys.stdout.flush()
...
def change_state_lte(*args):
    global driver
    print('interference_gui_support.change_state_lte')
    sys.stdout.flush()


def change_state_microwave(*args):
    global driver, microwaveActivation
    print('interference_gui_support.change_state_microwave')
    sys.stdout.flush()
...
def change_state_wifi(*args):
    ...
    print('interference_gui_support.change_state_wifi : ' + wifiActivation.get())
    sys.stdout.flush()
    setTraffic()
...
if __name__ == '__main__':
    import interference_gui
    interference_gui.vp_start_gui()
