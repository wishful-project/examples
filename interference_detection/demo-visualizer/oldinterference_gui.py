...
import interference_gui_support
def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = Tk()
    interference_gui_support.set_Tk_var()
    top = Demo_GUI (root)
    interference_gui_support.init(root, top)
    root.mainloop()

w = None
def create_Demo_GUI(root, *args, **kwargs):
    ...
    interference_gui_support.set_Tk_var()
    top = Demo_GUI (w)
    interference_gui_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Demo_GUI():
    global w
    w.destroy()
    w = None
...
class Demo_GUI:
    def __init__(self, top=None):
        ...
        self.file.add_command(
                ...
                background="wheat",
                command=interference_gui_support.Save,
                font="TkMenuFont",
                foreground="#000000",
                label="Save")
        ...
        self.file.add_command(
                ...
                activeforeground="#000000",
                background="wheat",
                command=interference_gui_support.Quit,
                font="TkMenuFont",
                foreground="#000000",
                label="Quit")
        ...
        self.TFrame1.place(relx=0.0, rely=0.12, relheight=0.79, relwidth=1.0)
        ...
        self.tFr39_tNo40.place(relx=0.01, rely=0.01, relheight=0.97
                , relwidth=0.98)
        ...
        self.LabelframeTopology.place(relx=0.02, rely=0.02, relheight=0.49
                , relwidth=0.36)
        ...
        self.LabelframeMonitor.place(relx=0.02, rely=0.53, relheight=0.43
                , relwidth=0.44)
        self.LabelframeMonitor.configure(relief=GROOVE)
        self.LabelframeMonitor.configure(foreground="black")
        self.LabelframeMonitor.configure(text='''Error Monitor''')
        ...
        self.LabelframeMonitor.configure(width=610)

        self.LabelframeSpectrum = LabelFrame(self.TNotebook1_t1)
        self.LabelframeSpectrum.place(relx=0.46, rely=0.53, relheight=0.44
                , relwidth=0.53)
        self.LabelframeSpectrum.configure(relief=GROOVE)
        self.LabelframeSpectrum.configure(foreground="black")
        self.LabelframeSpectrum.configure(text='''Spectrum''')
        self.LabelframeSpectrum.configure(background="#d9d9d9")
        self.LabelframeSpectrum.configure(highlightbackground="#d9d9d9")
        self.LabelframeSpectrum.configure(highlightcolor="black")
        self.LabelframeSpectrum.configure(width=740)

        self.LabelframeDetection1 = LabelFrame(self.TNotebook1_t1)
        self.LabelframeDetection1.place(relx=0.55, rely=0.02, relheight=0.49
                , relwidth=0.44)
        ...
        self.LabelframeController.place(relx=0.39, rely=0.02, relheight=0.49
                , relwidth=0.16)
        ...
        self.RadiobuttonRadiobuttonWifiOn.configure(variable=interference_gui_support.wifiActivation)
        ...
        self.RadiobuttonWifiOff.configure(variable=interference_gui_support.wifiActivation)
        ...
        self.LabelZigbee = Label(self.LabelframeController)
        self.LabelZigbee.place(relx=0.07, rely=0.17, height=31, width=49)
        self.LabelZigbee.configure(activebackground="#f9f9f9")
        self.LabelZigbee.configure(activeforeground="black")
        self.LabelZigbee.configure(background="#d9d9d9")
        self.LabelZigbee.configure(disabledforeground="#a3a3a3")
        self.LabelZigbee.configure(foreground="#000000")
        self.LabelZigbee.configure(highlightbackground="#d9d9d9")
        self.LabelZigbee.configure(highlightcolor="black")
        self.LabelZigbee.configure(text='''ZigBee''')
        ...
        self.LabelMicrowave = Label(self.LabelframeController)
        self.LabelMicrowave.place(relx=0.05, rely=0.38, height=21, width=69)
        self.LabelMicrowave.configure(activebackground="#f9f9f9")
        self.LabelMicrowave.configure(activeforeground="black")
        self.LabelMicrowave.configure(background="#d9d9d9")
        self.LabelMicrowave.configure(disabledforeground="#a3a3a3")
        self.LabelMicrowave.configure(foreground="#000000")
        self.LabelMicrowave.configure(highlightbackground="#d9d9d9")
        self.LabelMicrowave.configure(highlightcolor="black")
        self.LabelMicrowave.configure(text='''MicroWave''')

        self.RadiobuttonZigbeeOff = Radiobutton(self.LabelframeController)
        self.RadiobuttonZigbeeOff.place(relx=0.39, rely=0.19, relheight=0.08
                , relwidth=0.26)
        self.RadiobuttonZigbeeOff.configure(activebackground="#f4bcb2")
        self.RadiobuttonZigbeeOff.configure(activeforeground="black")
        self.RadiobuttonZigbeeOff.configure(background="#d9d9d9")
        self.RadiobuttonZigbeeOff.configure(disabledforeground="#a3a3a3")
        self.RadiobuttonZigbeeOff.configure(foreground="#000000")
        self.RadiobuttonZigbeeOff.configure(highlightbackground="#d9d9d9")
        self.RadiobuttonZigbeeOff.configure(highlightcolor="black")
        self.RadiobuttonZigbeeOff.configure(indicatoron="0")
        self.RadiobuttonZigbeeOff.configure(justify=LEFT)
        self.RadiobuttonZigbeeOff.configure(text='''Off''')
        self.RadiobuttonZigbeeOff.configure(value="0")
        self.RadiobuttonZigbeeOff.configure(variable=interference_gui_support.zigbeeActivation)

        self.RadiobuttonMicrowaveOff = Radiobutton(self.LabelframeController)
        self.RadiobuttonMicrowaveOff.place(relx=0.36, rely=0.38, relheight=0.08
                , relwidth=0.26)
        self.RadiobuttonMicrowaveOff.configure(activebackground="#f4bcb2")
        self.RadiobuttonMicrowaveOff.configure(activeforeground="black")
        self.RadiobuttonMicrowaveOff.configure(background="#d9d9d9")
        self.RadiobuttonMicrowaveOff.configure(disabledforeground="#a3a3a3")
        self.RadiobuttonMicrowaveOff.configure(foreground="#000000")
        self.RadiobuttonMicrowaveOff.configure(highlightbackground="#d9d9d9")
        self.RadiobuttonMicrowaveOff.configure(highlightcolor="black")
        self.RadiobuttonMicrowaveOff.configure(indicatoron="0")
        self.RadiobuttonMicrowaveOff.configure(justify=LEFT)
        self.RadiobuttonMicrowaveOff.configure(text='''Off''')
        self.RadiobuttonMicrowaveOff.configure(value="0")
        self.RadiobuttonMicrowaveOff.configure(variable=interference_gui_support.microwaveActivation)
        ...
        self.RadiobuttonLteOff.configure(variable=interference_gui_support.lteActivation)

        self.RadiobuttonZigbeeOn = Radiobutton(self.LabelframeController)
        self.RadiobuttonZigbeeOn.place(relx=0.68, rely=0.18, relheight=0.08
                , relwidth=0.25)
        self.RadiobuttonZigbeeOn.configure(activebackground="#f4bcb2")
        self.RadiobuttonZigbeeOn.configure(activeforeground="black")
        self.RadiobuttonZigbeeOn.configure(background="#d9d9d9")
        self.RadiobuttonZigbeeOn.configure(disabledforeground="#a3a3a3")
        self.RadiobuttonZigbeeOn.configure(foreground="#000000")
        self.RadiobuttonZigbeeOn.configure(highlightbackground="#d9d9d9")
        self.RadiobuttonZigbeeOn.configure(highlightcolor="black")
        self.RadiobuttonZigbeeOn.configure(indicatoron="0")
        self.RadiobuttonZigbeeOn.configure(justify=LEFT)
        self.RadiobuttonZigbeeOn.configure(text='''On''')
        self.RadiobuttonZigbeeOn.configure(value="1")
        self.RadiobuttonZigbeeOn.configure(variable=interference_gui_support.zigbeeActivation)
        ...
        self.RadiobuttonLteOn.configure(variable=interference_gui_support.lteActivation)

        self.RadiobuttonMicrowaveOn = Radiobutton(self.LabelframeController)
        self.RadiobuttonMicrowaveOn.place(relx=0.66, rely=0.38, relheight=0.08
                , relwidth=0.25)
        self.RadiobuttonMicrowaveOn.configure(activebackground="#f4bcb2")
        self.RadiobuttonMicrowaveOn.configure(activeforeground="black")
        self.RadiobuttonMicrowaveOn.configure(background="#d9d9d9")
        self.RadiobuttonMicrowaveOn.configure(disabledforeground="#a3a3a3")
        self.RadiobuttonMicrowaveOn.configure(foreground="#000000")
        self.RadiobuttonMicrowaveOn.configure(highlightbackground="#d9d9d9")
        self.RadiobuttonMicrowaveOn.configure(highlightcolor="black")
        self.RadiobuttonMicrowaveOn.configure(indicatoron="0")
        self.RadiobuttonMicrowaveOn.configure(justify=LEFT)
        self.RadiobuttonMicrowaveOn.configure(text='''On''')
        self.RadiobuttonMicrowaveOn.configure(value="1")
        self.RadiobuttonMicrowaveOn.configure(variable=interference_gui_support.microwaveActivation)

        self.LabelframeWaterFall = LabelFrame(self.TNotebook1_t2)
        self.LabelframeWaterFall.place(relx=0.01, rely=0.02, relheight=0.97
                , relwidth=0.49)
        self.LabelframeWaterFall.configure(relief=GROOVE)
        self.LabelframeWaterFall.configure(foreground="black")
        self.LabelframeWaterFall.configure(text='''WaterFall''')
        ...
        self.LabelframeWaterFall.configure(width=680)

        self.LabelframeCdfTime = LabelFrame(self.TNotebook1_t2)
        self.LabelframeCdfTime.place(relx=0.5, rely=0.02, relheight=0.32
                , relwidth=0.49)
        self.LabelframeCdfTime.configure(relief=GROOVE)
        self.LabelframeCdfTime.configure(foreground="black")
        self.LabelframeCdfTime.configure(text='''CFD Time''')
        self.LabelframeCdfTime.configure(background="#d9d9d9")
        self.LabelframeCdfTime.configure(highlightbackground="#d9d9d9")
        self.LabelframeCdfTime.configure(highlightcolor="black")
        self.LabelframeCdfTime.configure(width=690)

        self.LabelframeCdfBw = LabelFrame(self.TNotebook1_t2)
        self.LabelframeCdfBw.place(relx=0.5, rely=0.35, relheight=0.32
                , relwidth=0.49)
        self.LabelframeCdfBw.configure(relief=GROOVE)
        self.LabelframeCdfBw.configure(foreground="black")
        self.LabelframeCdfBw.configure(text='''CDF BW''')
        self.LabelframeCdfBw.configure(background="#d9d9d9")
        self.LabelframeCdfBw.configure(highlightbackground="#d9d9d9")
        self.LabelframeCdfBw.configure(highlightcolor="black")
        self.LabelframeCdfBw.configure(width=690)

        self.LabelframeCdfFreq = LabelFrame(self.TNotebook1_t2)
        self.LabelframeCdfFreq.place(relx=0.5, rely=0.68, relheight=0.31
                , relwidth=0.49)
        self.LabelframeCdfFreq.configure(relief=GROOVE)
        self.LabelframeCdfFreq.configure(foreground="black")
        self.LabelframeCdfFreq.configure(text='''CDF Freq''')
        self.LabelframeCdfFreq.configure(background="#d9d9d9")
        self.LabelframeCdfFreq.configure(highlightbackground="#d9d9d9")
        self.LabelframeCdfFreq.configure(highlightcolor="black")
        self.LabelframeCdfFreq.configure(width=690)

        self.GatewayConfFrame = LabelFrame(self.TNotebook1_t4)
        self.GatewayConfFrame.place(relx=0.01, rely=0.02, relheight=0.47
                , relwidth=0.66)
        ...
        self.FileDialogButton.configure(command=interference_gui_support.OpenFileDialog)
        ...
        self.StartGatewayButton.configure(command=interference_gui_support.StartGatewayCommand)
        ...
        self.StopGatewayButton.configure(command=interference_gui_support.StopGatewayCommand)
        ...
        self.Label1.place(relx=0.01, rely=-0.01, height=109, width=386)
        ...
        self._img1 = PhotoImage(file="./logo_wishful.png")
        self.Label1.configure(image=self._img1)
        self.Label1.configure(text='''Label''')

        self.Label2 = Label(top)
        self.Label2.place(relx=0.69, rely=0.04, height=52, width=392)
        ...
        self._img2 = PhotoImage(file="./logo_cnit2.png")
