"""
upi_executor_agent.py: Implementation of WiSHFUL control agent for Contiki

Usage:
   upi_executor_agent.py [options] [-q | -v]
...
Example:
   ./upi_executor_agent -v --config ./agent_config.yaml
...
log = logging.getLogger('upi_executor_agent.main')
