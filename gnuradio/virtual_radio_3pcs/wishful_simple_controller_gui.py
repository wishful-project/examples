...
class AppGui():
    ...
    def __init__(self, root):
        self.vr1_pkt_recv_info, self.vr1_pkt_right_info, self.vr1_cf_info, self.vr1_bw_info = self.build_vr_menu(1, root, "VR LTE", self.vr1_tx_amplitude_update)

        self.vr2_pkt_recv_info, self.vr2_pkt_right_info, self.vr2_cf_info, self.vr2_bw_info = self.build_vr_menu(2, root, "VR NB-IoT", self.vr2_tx_amplitude_update)

    def build_vr_menu(self, vr_id, root, title, tx_amplitude_callback):
