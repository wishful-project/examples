...
private:
  ...
  double maxGain_x;
  double stepGain_x;
  bool gainknob_used_x;

  void processSyncMargin(double m);
  double min_sync_margin_tx_x;
  double max_sync_margin_tx_x;
  double step_sync_margin_tx_x;
  bool marginknob_used_x;
