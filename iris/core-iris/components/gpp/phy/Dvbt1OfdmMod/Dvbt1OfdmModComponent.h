 ...
 *
 * This blocks accepts in input complex float values and
 ...
 *                    distorted by the Dvbt1Interpolator block. The type of dis-
 *                    tortion is decided by the algorithm adopted internally by
