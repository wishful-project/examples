 ...
 *
 * Dvbt1ConvEncoderComponent is the third block composing the DVB-T transmission chain.
 ...
 *
 * This blocks accepts in input elements in uint8_t (octets of bits) and generates
