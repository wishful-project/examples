...
def local_event_listener(control_engine):
    ...
    print(("local_event_listener started - Name: {}, Id: {} - STARTED".format(control_engine.name, control_engine.id)))
