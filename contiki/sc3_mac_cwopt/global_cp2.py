...
def main(args):
    ...
    for i in range(0,len(contiki_nodes),2):
        receiver_sender_pairs.append([contiki_nodes[i], contiki_nodes[i+1]])
    ...
    ret = taisc_manager.update_slotframe('./sc3_mac_cwopt/taisc_slotframe.csv')
    log.info(ret)
